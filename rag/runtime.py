...
def get_runtime_config() -> RagRuntimeConfig:
    ...
    return RagRuntimeConfig(
        ...
        collection_mit13=os.getenv("QDRANT_COLLECTION_MIT13", "mit13_course_BAAI_bge_large_en_v1_5"),
        collection_mit14=os.getenv("QDRANT_COLLECTION_MIT14", "mit14_course_BAAI_bge_large_en_v1_5"),
        collection_cs50=os.getenv("QDRANT_COLLECTION_CS50", "harvard_cs50_BAAI_bge_large_en_v1_5"),
        collection_guidelines=os.getenv("QDRANT_COLLECTION_GUIDELINES", "cpp_guidelines_BAAI_bge_large_en_v1_5"),
