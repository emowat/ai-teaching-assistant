# -*- coding: utf-8 -*-
"""Log_Model_eval.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Uqm0hCjGypso-UK4aUV2bCzweq8Cozj3
"""
...
demo_macro_samples= build_Macro_samples(dataset)
print(len(demo_macro_samples), "macro smaples built from synethic dataset")
print("-"*100)
...
print("-"*100)
print("sys_promt:", demo_micro_samples[0].get("sys_promt"))
print("-"*100)
...
def visable_text_only(ta_text): #return code inside <analysis> in the TA's reasonsoning
  return re.findall(r'<analysis>(.*?)</analysis>', ta_text, re.DOTALL)

def code_leak_check(ta_text, student_code): #check to see if TA leaked code (1 yes, 0 no)
  violation= check_code_leakage(visable_text_only(ta_text, student_code or "") )
...
def run_mirco_eval(samples, judge_model, judge_prompt):
  ...
  for i, score in  enumerate(samples) :
    judge_model_prompt= judge_prompt.format(     #create judge prompt
                                            sys_promt= score['sys_promt'],   # the rules
...
with open("/content/drive/My Drive/DATASCI210/Notebooks/Model_eval_Results/Log/Baseline_Macro_LLM-as-a-judge_eval_c_plus_plus_dataset.json", 'w') as f:
...
with open("/content/drive/My Drive/DATASCI210/Notebooks/Model_eval_Results/Log/Baseline_Micro_LLM-as-a-judge_eval_c_plus_plus_dataset.json", 'w') as f:
